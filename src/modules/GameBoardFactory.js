...
export const GameBoardFactory = () => {
  ...
  console.log('gameBoard.placeShipOnBoard =', gameBoard.placeShipOnBoard) 
  // the above console.logs show that gameBoard has the placeShipOnBoard 
  // methods at the time of returning.
  return { gameBoard };
};
